 ...
 */
let config = {
    darksky_api: "e85eacea2cd9fe3c9879ab78a98cc63e", //从https://darksky.net/dev/ 上申请key填入即可
    aqicn_api: "08c84d235a299cb2724c98d8746b2b63426e4a83", //从http://aqicn.org/data-platform/token/#/ 上申请key填入即可
    huweather_apiKey: "b8ce27332ef6491ca2495114596a7a1f", //和风天气APIkey,可自行前往 https://dev.heweather.com/ 进行获取(注意key类型选WebApi)
    lat_lon: "31.3860779, 121.4101884", //请填写经纬度,直接从谷歌地图中获取即可
    ...
    show: {
        //普通每天的
        template: {
            title: `[彩云天气🍭] $[city]$[district]  •  $[summary]`,
